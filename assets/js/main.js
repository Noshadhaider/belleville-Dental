...
(function() {
 ...
 /**
   ...
   */
   ...
   const closeButton2 = document.querySelector(".close-button1");
   ...
   const modal3 = document.querySelector(".modal1");
   const trigger3 = document.querySelector(".trigger3 ");
   const closeButton3 = document.querySelector(".close-button1");
   
   function toggleModal() {
       modal3.classList.toggle("show-modal1");
       document.body.style.overflow = "hidden";
       document.body.style.height = "100%";
   }
   
   function toggleModal1() {
    closeButton3.classList.toggle("show-modal1");
